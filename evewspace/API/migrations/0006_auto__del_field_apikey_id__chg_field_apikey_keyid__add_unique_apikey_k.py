...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('API_apikey', 'id')


        # Changing field 'APIKey.keyid'
        db.alter_column('API_apikey', 'keyid', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
        # Adding unique constraint on 'APIKey', fields ['keyid']
        db.create_unique('API_apikey', ['keyid'])


    def backwards(self, orm):
        # Removing unique constraint on 'APIKey', fields ['keyid']
        db.delete_unique('API_apikey', ['keyid'])


        # User chose to not deal with backwards NULL issues for 'APIKey.id'
        raise RuntimeError("Cannot reverse this migration. 'APIKey.id' and its values cannot be restored.")

        # Changing field 'APIKey.keyid'
        db.alter_column('API_apikey', 'keyid', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'API.apicharacter': {
            ...
            'apikey': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'characters'", 'null': 'True', 'to': "orm['API.MemberAPIKey']"}),
