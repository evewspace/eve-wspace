...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'APIKey', fields ['keyid']
        db.delete_unique(u'API_apikey', ['keyid'])
        ...
        # Adding field 'APIKey.id'
        db.add_column(u'API_apikey', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)

        # Adding field 'APIKey.tenant'
        db.add_column(u'API_apikey', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='api_keys', to=orm['core.Tenant']),
                      keep_default=False)


        # Changing field 'APIKey.keyid'
        db.alter_column(u'API_apikey', 'keyid', self.gf('django.db.models.fields.IntegerField')())
        # Adding unique constraint on 'APIKey', fields ['tenant', 'keyid']
        db.create_unique(u'API_apikey', ['tenant_id', 'keyid'])


    def backwards(self, orm):
        # Removing unique constraint on 'APIKey', fields ['tenant', 'keyid']
        db.delete_unique(u'API_apikey', ['tenant_id', 'keyid'])


        # Changing field 'MemberAPIKey.user'
        db.alter_column(u'API_memberapikey', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'APIKey.id'
        db.delete_column(u'API_apikey', u'id')

        # Deleting field 'APIKey.tenant'
        db.delete_column(u'API_apikey', 'tenant_id')


        # Changing field 'APIKey.keyid'
        db.alter_column(u'API_apikey', 'keyid', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
        # Adding unique constraint on 'APIKey', fields ['keyid']
        db.create_unique(u'API_apikey', ['keyid'])
