...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('API_apicharacter', 'apikey_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['API.MemberAPIKey']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'APICharacter.apikey'
        raise RuntimeError("Cannot reverse this migration. 'APICharacter.apikey' and its values cannot be restored.")
