...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.WormholeType.objects.filter(name='C248').update(lifetime=16)
        orm.WormholeType.objects.filter(name='E545').update(lifetime=16)
        orm.WormholeType.objects.filter(name='K329').update(lifetime=16)
        orm.WormholeType.objects.filter(name='K346').update(lifetime=16)
        orm.WormholeType.objects.filter(name='S199').update(lifetime=16)
        orm.WormholeType.objects.filter(name='V283').update(lifetime=16)
        orm.WormholeType.objects.filter(name='Z060').update(lifetime=16)
        orm.WormholeType.objects.filter(name='Z142').update(lifetime=16)
        

    def backwards(self, orm):
        orm.WormholeType.objects.filter(name='C248').update(lifetime=24)
        orm.WormholeType.objects.filter(name='E545').update(lifetime=24)
        orm.WormholeType.objects.filter(name='K329').update(lifetime=24)
        orm.WormholeType.objects.filter(name='K346').update(lifetime=24)
        orm.WormholeType.objects.filter(name='S199').update(lifetime=24)
        orm.WormholeType.objects.filter(name='V283').update(lifetime=24)
        orm.WormholeType.objects.filter(name='Z060').update(lifetime=24)
        orm.WormholeType.objects.filter(name='Z142').update(lifetime=24)
