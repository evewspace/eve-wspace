...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for old_sys in orm['Map.system'].objects.all():
            new_sys = orm['Map.tenantsystemdata']()
            new_sys.tenant_id = 1
            new_sys.system = old_sys
            new_sys.updated = old_sys.updated
            new_sys.first_visited = old_sys.first_visited
            new_sys.importance = old_sys.importance
            new_sys.last_visited = old_sys.last_visited
            new_sys.occupied = old_sys.occupied
            new_sys.info = old_sys.info
            new_sys.lastscanned = old_sys.lastscanned
            new_sys.save()
