...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'Map_map', ['name'])

        # Adding unique constraint on 'Map', fields ['tenant', 'name']
        db.create_unique(u'Map_map', ['tenant_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Map', fields ['tenant', 'name']
        db.delete_unique(u'Map_map', ['tenant_id', 'name'])

        # Adding unique constraint on 'Map', fields ['name']
        db.create_unique(u'Map_map', ['name'])
    ...
    models = {
        u'Map.destination': {
            ...
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'destinations'", 'null': 'True', 'to': u"orm['core.Tenant']"}),
        ...
        u'Map.map': {
            'Meta': {'unique_together': "(('tenant', 'name'),)", 'object_name': 'Map'},
