...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signature.modified_by'
        db.add_column('Map_signature', 'modified_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='signatures', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Signature.modified_time'
        db.add_column('Map_signature', 'modified_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signature.modified_by'
        db.delete_column('Map_signature', 'modified_by_id')

        # Deleting field 'Signature.modified_time'
        db.delete_column('Map_signature', 'modified_time')
