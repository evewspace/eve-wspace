...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Destination.capital'
        db.delete_column('Map_destination', 'capital')

        # Adding field 'Destination.user'
        db.add_column('Map_destination', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='destinations', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Destination.capital'
        db.add_column('Map_destination', 'capital',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Destination.user'
        db.delete_column('Map_destination', 'user_id')
