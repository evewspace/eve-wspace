...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'Map_signature', ['system_id', 'sigid'])

        # Adding model 'TenantSystemData'
        db.create_table(u'Map_tenantsystemdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tenant_data', to=orm['Map.System'])),
            ('tenant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='system_intel', to=orm['core.Tenant'])),
        ...
        db.send_create_signal(u'Map', ['TenantSystemData'])

        # Adding unique constraint on 'TenantSystemData', fields ['system', 'tenant']
        db.create_unique(u'Map_tenantsystemdata', ['system_id', 'tenant_id'])


        # Changing field 'MapLog.user'
        db.alter_column(u'Map_maplog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.EWSUser']))

        # Changing field 'Destination.user'
        db.alter_column(u'Map_destination', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.EWSUser']))
        # Adding field 'Map.tenant'
        db.add_column(u'Map_map', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='maps', to=orm['core.Tenant']),
                      keep_default=False)


        # Changing field 'Snapshot.user'
        db.alter_column(u'Map_snapshot', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.EWSUser']))
        # Adding field 'Signature.tenant'
        db.add_column(u'Map_signature', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='signatures', to=orm['core.Tenant']),
                      keep_default=False)


        # Changing field 'Signature.modified_by'
        db.alter_column(u'Map_signature', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.EWSUser']))

        # Changing field 'Signature.owned_by'
        db.alter_column(u'Map_signature', 'owned_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.EWSUser']))
        # Adding unique constraint on 'Signature', fields ['tenant', 'system', 'sigid']
        db.create_unique(u'Map_signature', ['tenant_id', 'system_id', 'sigid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Signature', fields ['tenant', 'system', 'sigid']
        db.delete_unique(u'Map_signature', ['tenant_id', 'system_id', 'sigid'])

        # Removing unique constraint on 'TenantSystemData', fields ['system', 'tenant']
        db.delete_unique(u'Map_tenantsystemdata', ['system_id', 'tenant_id'])

        # Deleting model 'TenantSystemData'
        db.delete_table(u'Map_tenantsystemdata')


        # Changing field 'MapLog.user'
        db.alter_column(u'Map_maplog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Destination.user'
        db.alter_column(u'Map_destination', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Deleting field 'Map.tenant'
        db.delete_column(u'Map_map', 'tenant_id')


        # Changing field 'Snapshot.user'
        db.alter_column(u'Map_snapshot', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'Signature.tenant'
        db.delete_column(u'Map_signature', 'tenant_id')


        # Changing field 'Signature.modified_by'
        db.alter_column(u'Map_signature', 'modified_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Signature.owned_by'
        db.alter_column(u'Map_signature', 'owned_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Adding unique constraint on 'Signature', fields ['system', 'sigid']
        db.create_unique(u'Map_signature', ['system_id', 'sigid'])
    ...
    models = {
        ...
        u'Map.signature': {
            'Meta': {'ordering': "['sigid']", 'unique_together': "(('tenant', 'system', 'sigid'),)", 'object_name': 'Signature'},
            ...
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'signatures'", 'to': u"orm['core.Tenant']"}),
        ...
        u'Map.tenantsystemdata': {
            'Meta': {'unique_together': "(('system', 'tenant'),)", 'object_name': 'TenantSystemData'},
            'first_visited': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'importance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'info': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'lastscanned': ('django.db.models.fields.DateTimeField', [], {}),
            'occupied': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'system': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tenant_data'", 'to': u"orm['Map.System']"}),
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'system_intel'", 'to': u"orm['core.Tenant']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        u'Map.wormhole': {
