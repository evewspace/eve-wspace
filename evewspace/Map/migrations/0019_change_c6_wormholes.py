...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.WormholeType.objects.filter(name='C391').update(source='6')
        orm.WormholeType.objects.filter(name='C248').update(source='6')

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.WormholeType.objects.filter(name='C391').update(source='NH')
        orm.WormholeType.objects.filter(name='C248').update(source='NH')
