...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WSystem.is_shattered'
        db.add_column(u'Map_wsystem', 'is_shattered',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WSystem.is_shattered'
        db.delete_column(u'Map_wsystem', 'is_shattered')
