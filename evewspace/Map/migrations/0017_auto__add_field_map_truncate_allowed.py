...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Map.truncate_allowed'
        db.add_column(u'Map_map', 'truncate_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.truncate_allowed'
        db.delete_column(u'Map_map', 'truncate_allowed')
