...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signature.owned_by'
        db.add_column('Map_signature', 'owned_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sigs_owned', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Signature.owned_time'
        db.add_column('Map_signature', 'owned_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signature.owned_by'
        db.delete_column('Map_signature', 'owned_by_id')

        # Deleting field 'Signature.owned_time'
        db.delete_column('Map_signature', 'owned_time')
    ...
    models = {
        ...
        'Map.destination': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'destinations'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'Map.ksystem': {
        ...
        'Map.signature': {
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'signatures'", 'null': 'True', 'to': "orm['auth.User']"}),
            'modified_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'owned_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sigs_owned'", 'null': 'True', 'to': "orm['auth.User']"}),
