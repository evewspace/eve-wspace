...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Destination.tenant'
        db.add_column(u'Map_destination', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='destinations', null=True, to=orm['core.Tenant']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Destination.tenant'
        db.delete_column(u'Map_destination', 'tenant_id')
