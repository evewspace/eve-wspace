...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EWSUser.current_tenant'
        db.add_column(u'account_ewsuser', 'current_tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='active_users', null=True, to=orm['core.Tenant']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EWSUser.current_tenant'
        db.delete_column(u'account_ewsuser', 'current_tenant_id')
