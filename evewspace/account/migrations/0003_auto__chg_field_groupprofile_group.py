...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('account_groupprofile', 'group_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.Group']))

    def backwards(self, orm):

        # Changing field 'GroupProfile.group'
        db.alter_column('account_groupprofile', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['auth.Group']))
