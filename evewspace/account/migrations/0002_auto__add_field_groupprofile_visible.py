...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupProfile.visible'
        db.add_column('account_groupprofile', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupProfile.visible'
        db.delete_column('account_groupprofile', 'visible')
