...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SubscriptionGroup', fields ['name']
        db.delete_unique(u'Alerts_subscriptiongroup', ['name'])


        # Changing field 'Subscription.user'
        db.alter_column(u'Alerts_subscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.EWSUser']))
        # Adding field 'SubscriptionGroup.tenant'
        db.add_column(u'Alerts_subscriptiongroup', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='alert_groups', to=orm['core.Tenant']),
                      keep_default=False)

        # Adding unique constraint on 'SubscriptionGroup', fields ['name', 'tenant']
        db.create_unique(u'Alerts_subscriptiongroup', ['name', 'tenant_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SubscriptionGroup', fields ['name', 'tenant']
        db.delete_unique(u'Alerts_subscriptiongroup', ['name', 'tenant_id'])


        # Changing field 'Subscription.user'
        db.alter_column(u'Alerts_subscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'SubscriptionGroup.tenant'
        db.delete_column(u'Alerts_subscriptiongroup', 'tenant_id')

        # Adding unique constraint on 'SubscriptionGroup', fields ['name']
        db.create_unique(u'Alerts_subscriptiongroup', ['name'])
    ...
    models = {
        ...
        u'Alerts.subscriptiongroup': {
            'Meta': {'unique_together': "(('name', 'tenant'),)", 'object_name': 'SubscriptionGroup'},
            ...
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'alert_groups'", 'to': u"orm['core.Tenant']"})
        },
        u'Alerts.subscriptiongrouppermission': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sub_group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'group_permissions'", 'to': u"orm['Alerts.SubscriptionGroup']"}),
            'user_group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'alert_groups'", 'to': u"orm['auth.Group']"})
        },
        u'Map.map': {
