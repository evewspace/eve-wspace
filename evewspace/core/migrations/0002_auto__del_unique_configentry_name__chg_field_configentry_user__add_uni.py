...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ConfigEntry', fields ['name']
        db.delete_unique(u'core_configentry', ['name'])
        ...
        # Adding unique constraint on 'ConfigEntry', fields ['name', 'user']
        db.create_unique(u'core_configentry', ['name', 'user_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'ConfigEntry', fields ['name', 'user']
        db.delete_unique(u'core_configentry', ['name', 'user_id'])

        # Adding unique constraint on 'ConfigEntry', fields ['name']
        db.create_unique(u'core_configentry', ['name'])
    ...
    models = {
        ...
        u'core.configentry': {
            'Meta': {'unique_together': "(('name', 'user'),)", 'object_name': 'ConfigEntry'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
