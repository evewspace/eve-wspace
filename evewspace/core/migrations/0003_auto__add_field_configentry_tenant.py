...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConfigEntry.tenant'
        db.add_column(u'core_configentry', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='settings', null=True, to=orm['core.Tenant']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConfigEntry.tenant'
        db.delete_column(u'core_configentry', 'tenant_id')
